...
import { RichTextEditorComponent, MarkdownEditor, Inject, Toolbar, Image, Link, QuickToolbar, Table } from '@syncfusion/ej2-react-richtexteditor';
import { SampleBase } from './sample-base';
import { createElement, isNullOrUndefined, addClass, removeClass, Browser } from '@syncfusion/ej2-base';
import * as Marked from 'marked';
import "./textEditor.css"

class TextEditor extends SampleBase {
    constructor() {
        super(...arguments);
